...
class Authenticate extends CI_Controller {
  ...
  {
    if($this->input->post('resetlink')){
          $this->load->model('user_model');
          $this->user_model->resetlink();
    }
  ...
  public function resetpassword()
  {
    ...
    $result = $this->user_model->check_token($token);
    
    if( $this->input->post('change_password') && $result ){
          $this->load->model('user_model');
          $this->user_model->change_password();
          $this->load->view('resetpassword/index', $result);
    ...
    else
    {
      ...
      echo "Fejl i nulstillingslink, prøv at nulstille igen.";
    }
  }
