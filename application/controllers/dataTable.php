...
public function getTable(){
    ...
    if($_POST['page'] == "transfer"){
      if(isset($_POST['boutique_id']) && $_POST['boutique_id']){
        $boutique_id_selected = "AND boutique_id = '".$_POST['boutique_id']."'";
      }else{
        $boutique_id_selected = '';
      }
      ...
      if($status == 1){
        ...
        $extraWhere = "(type = 'bought' $boutique_id_selected AND exchange = '0' $where_add)";
