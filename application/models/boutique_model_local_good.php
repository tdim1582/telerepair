    ...
    function create_counting(){
	    ...
	    */
		...
		if ($raport_emails && $raport_emails != '') {
			...
			$file_name = basename('assets/pdf/raport_'.$id.'.pdf');

			$uid = md5(uniqid(time()));
			$content = file_get_contents( 'assets/pdf/raport_'.$id.'.pdf');
			$content = chunk_split(base64_encode($content));

			$message = "--" . $uid . "\r\n" . "Content-type:text/html; charset=iso-8859-1\r\n" . "<html>" . $message . "</html>\r\n\r\n";
			$message .= "--".$uid."\r\n";
			$message .= "Content-Type: application/octet-stream; name=\""."raport_".$id.".pdf"."\"\r\n";
