        ...
        <div class="row">
	        ...
	        <hr />
	         ...
	         <div class="col-md-6">
		        ...
		        <input type="text" class="form-control" <?php if($customer_info): echo 'value="'.$customer_info[0]->company.'"'; endif; ?> name="company" style="margin-bottom: 10px" />
	        </div>

	        <div class="col-md-6">
		        <label>Sælger navn</label>
		        <input type="text" class="form-control" name="seller_name" <?php if($customer_info): echo 'value="'.$customer_info[0]->name.'"'; endif; ?>  required name="password" required style="margin-bottom: 10px" />
	        </div>
