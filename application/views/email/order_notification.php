        ...
        <table border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background-color: #f6f6f6;">
            <tr>
                ...
                <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
                    <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 500px; padding: 10px;">
                            ...
                            <tr>
                                <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px; ">
                                        ...
                                        <tr>
											...
											<?php
												...
												echo '<table width="100%" border="0" cellspacing="0" cellpadding="0">';
													...
													// echo "<img src='".base_url('assets/images/logo-green.png')."' width='200' align='middle' style='text-align:center; margin: auto; margin-top:30px' /><br/><br />";
													echo '</td></tr></table>';
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin-top: 40px;">
                                      <tr valign="top" style="display: flex;align-items: center;">
                                    ...
                                    <table style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin-top: 40px;">
                                      <tr>
                                        <td >
                                          <?=date("d/m/Y H:i",$order['created_timestamp']);?><br />
                                        </td>
                                        <td align="right">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin-top: 40px;">
                                      <tr valign="top">
                                        <td width="50%" style="text-transform: uppercase">
                                          ...
                                          <?php if ($order['name']) {echo $order['name'] + '<br/>';} ?>
                                    ...
                                    <div style="max-width:380px; margin-top: 30px;">
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 200px;">
                                        <?php if($order['price'] != $order['subtotal']){ ?>
                                        ...
                                        <tr style="font-weight: bold; ">
                                          <td style="text-align:left; border-bottom: 1px solid #000">RABAT (<?php echo number_format((1 - $order['subtotal']/$order['price'])*100,2,',','.'); ?>%)</td>
                                          <td style="text-align:right; border-bottom: 1px solid #000"><?=number_format(($order['price'] - $order['subtotal']),2,',','.');?> </td>
                                        </tr>
                                      <?php } ?>
                                      <tr style="font-weight: bold; ">
