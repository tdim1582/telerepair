...
<h1>
	Kasseafstemning
	<div style="font-size: 13px; font-weight: normal; margin-top: 15px">
...
<div class="row">
<div style="<?php if (!$email) {echo("display: flex; flex-direction: column;"); }?>">
	...
	<div class="col-md-6 col-xs-6">
		...
		<table class="table">
			...
			<tr>
				...
				<td style=" "><?=number_format($dankort,2,',','.');?> kr</td>
			</tr>
			<tr>
				<td>Danske EC/MC/VI</td>
				<td style=" "><?=number_format($danskeecmcvi,2,',','.');?> kr</td>
			</tr>
			<tr>
				<td>Udl. EC/MC/VI/JCB</td>
				<td style=" "><?=number_format($udlexmxvijcb,2,',','.');?> kr</td>
			</tr>
			<tr>
				<td>Gebyr</td>
				<td style=" ">-<?=number_format($gebyr,2,',','.');?> kr</td>
			</tr>
			
			<tr>
				<td><b>TOTAL</b></td>
				<td style=" "><b><?=number_format($total_card,2,',','.');?> kr</b></td>
			</tr>
			
			<tr>
				<td><b>Difference</b></td>
				<td style=" "><b><?=number_format($card_diff,2,',','.');?> kr</b></td>
			</tr>
	...
	<?php 
		if (!$email && file_exists('assets/pdf/raport_'.$id.'.pdf')) {echo('<div class="col-md-6" ><a href="/assets/pdf/raport_'.$id.'.pdf" target="_blank"> Download raport </a></div>'); }
	?>
	<div class="col-md-6" style="float: <?php if ($float == 'left') {echo('left');} else {echo('right');}?>; margin-top: 50px">
