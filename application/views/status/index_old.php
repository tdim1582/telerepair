		...
		<div class="table-responsive">
			...
			<table class="table" style="margin-top: 15px">
			  <tbody>
			  	...
			  	<tr>
			  		<td style="border-top: 1px dashed #2e2e2e; font-size: 20px"><b>DIFFERENCE</b></td>
			  		<td style="border-top: 1px dashed #2e2e2e; font-size: 20px"><b class="cardResultManuel">-</b></td>
			  	</tr>
			...
			<table class="table" style="margin-top: 15px">
			  <tbody>
			  	...
			  	<tr>
			  		<td width="200px"><b>Primo</b></td>
			  		<td colspan="3"><?=number_format($primo_amount,2,',','.');?></td>
			  	</tr>
			  	
			  	<tr>
			  		<td width="200px"><b>Kontantomsætning</b></td>
			  		<td colspan="3"><?=number_format($cash,2,',','.');?></td>
			  	</tr>
			  	
			  	<tr>
			  		<td width="200px"><b>Total</b></td>
			  		<td colspan="3"><?=number_format($cash+$primo_amount,2,',','.');?></td>
			  	</tr>
			  	<tr>
			  		<td><b>50 øre</b></td>
			  		<td><input type="text" class="form-control manuelCash50ore calculate_diff_cash" name="halvore" value="<?=$halvore;?>" /></td>
			  		<td><b>50 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash50kr calculate_diff_cash" value="<?=$halvtredskr;?>" name="halvtredskr" /></td>
			  	</tr>
			  	<tr>
			  		<td><b>1 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash1kr calculate_diff_cash" value="<?=$enkr;?>" name="enkr" /></td>
			  		<td><b>100 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash100kr calculate_diff_cash" value="<?=$hundkr;?>" name="hundkr" /></td>
			  	</tr>
			  	<tr>
			  		<td><b>2 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash2kr calculate_diff_cash" value="<?=$tokr;?>" name="tokr" /></td>
			  		<td><b>200 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash200kr calculate_diff_cash" value="<?=$tohundkr;?>" name="tohundkr" /></td>
			  	</tr>
			  	<tr>
			  		<td><b>5 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash5kr calculate_diff_cash" value="<?=$femkr;?>" name="femkr" /></td>
			  		<td><b>500 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash500kr calculate_diff_cash" value="<?=$femhundkr;?>" name="femhundkr" /></td>
			  	</tr>
			  	<tr>
			  		<td><b>10 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash10kr calculate_diff_cash" value="<?=$tikr;?>" name="tikr" /></td>
			  		<td><b>1000 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash1000kr calculate_diff_cash" value="<?=$tusindkr;?>" name="tusindkr" /></td>
			  	</tr>
			  	<tr>
			  		<td><b>20 kr</b></td>
			  		<td><input type="text" class="form-control manuelCash20kr calculate_diff_cash" value="<?=$tyvekr;?>" name="tyvekr" /></td>
			  	</tr>
			  	<tr>
			  		<td style="border-top: 1px dashed #2e2e2e; font-size: 20px"><b>DIFFERENCE</b></td>
			  		<td style="border-top: 1px dashed #2e2e2e; font-size: 20px"><b class="cashResultManuel">-</b></td>
			  	</tr>
