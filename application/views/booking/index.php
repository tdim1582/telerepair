    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				<table class='table table-striped'>
					...
					<tr>
						<td>Model:</td><td id='booking_model'></td>
					</tr>
					<tr>
	   ...
	   eventRender: function (calev, elt, view) {
			...
			if (calev.start._d.getTime() < ntoday.getTime()) {
				...
				elt.children().addClass("past");
					...
					if (calev.page_source ==  'macservice.dk') { 
					    elt.addClass("past-ms");
					}
			}
			if (calev.page_source ==  'macservice.dk') {
			    elt.css('backgroundColor','blue');
			    console.log(calev);
			}
		},
...
<style>
    .fc-event.past-ms {
        background-color: #4e4242 !important;
    }
</style>
